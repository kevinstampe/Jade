...
// The decoder and portrait preview use the same central square of the frame.
#define CAMERA_SCAN_MARGIN 20
#define CAMERA_SCAN_SIZE                                                                                           \
    ((CAMERA_IMAGE_WIDTH < CAMERA_IMAGE_HEIGHT ? CAMERA_IMAGE_WIDTH : CAMERA_IMAGE_HEIGHT) - CAMERA_SCAN_MARGIN)
